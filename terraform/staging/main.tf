module "resources" {
  ...
  jupyterhub_singleuser_image_tag  = "2021.09.22.0"
  python_image                     = "mcr.microsoft.com/planetary-computer/python:2021.09.22.0"
  r_image                          = "mcr.microsoft.com/planetary-computer/r:2021.09.22.0"
  gpu_pytorch_image                = "mcr.microsoft.com/planetary-computer/gpu-pytorch:2021.09.22.0"
