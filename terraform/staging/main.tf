module "resources" {
  ...
  jupyterhub_singleuser_image_tag  = "2022.04.05.0"
  python_image                     = "pcccr.azurecr.io/public/planetary-computer/python:2022.04.05.0"
  r_image                          = "pcccr.azurecr.io/public/planetary-computer/r:2022.01.17.0"
  gpu_pytorch_image                = "pcccr.azurecr.io/public/planetary-computer/gpu-pytorch:2022.04.05.0"
